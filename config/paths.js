...
// 获取所有入口js
// const entriesPath = globby.sync([resolveApp("src")]).map(filePath => {
//     let tmp = filePath.split("/");
//     let name = tmp[tmp.length - 2];
//     return { path: filePath, name };
// });
// const entriesPath = globby.sync([path.join(resolveApp("src"), "/*/index.js")]);

function getEntriesPath(source) {
...
module.exports = {
    ...
    entriesPath: getEntriesPath("src/pages"),
};
